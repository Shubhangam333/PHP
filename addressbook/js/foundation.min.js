    ...
    Foundation.libs.slider = {
      ...
      events: function () {
        ...
        e(this.scope)
          ...
          .on(
            ...
            function (t) {
              n.cache.active ||
                (t.preventDefault(), n.set_active_slider(e(t.target)));
            }
          )
          .on(
            ...
            function (t) {
              !n.cache.active ||
                (t.preventDefault(),
                e.data(n.cache.active[0], 'settings').vertical
                  ? n.calculate_position(
                      n.cache.active,
                      t.pageY ||
                        t.originalEvent.clientY ||
      ...
      calculate_position: function (t, n) {
        ...
        requestAnimationFrame(function () {
          var e;
          Foundation.rtl && !i.vertical
            ? (e = r.limit_to((a + u - n) / u, 0, 1))
            : (e = r.limit_to((n - a) / u, 0, 1)),
            (e = i.vertical ? 1 - e : e);
      ...
      set_ui: function (t, n) {
        ...
        Foundation.rtl && !r.vertical && (u = -u),
          ...
          r.vertical
            ? t.siblings('.range-slider-active-segment').css('height', a + '%')
      ...
      initialize_settings: function (t) {
        ...
        n.vertical
          ? (e.data(t, 'bar_o', e(t).parent().offset().top),
            e.data(t, 'bar_l', e(t).parent().outerHeight()),
            e.data(t, 'handle_o', e(t).offset().top),
            e.data(t, 'handle_l', e(t).outerHeight()))
          : (e.data(t, 'bar_o', e(t).parent().offset().left),
            e.data(t, 'bar_l', e(t).parent().outerWidth()),
            e.data(t, 'handle_o', e(t).offset().left),
            e.data(t, 'handle_l', e(t).outerWidth())),
      ...
      set_initial_position: function (t) {
        var n = e.data(t.children('.range-slider-handle')[0], 'settings'),
          r = n.initial
            ? n.initial
            : Math.floor(((n.end - n.start) * 0.5) / n.step) * n.step + n.start,
      ...
      set_value: function (t) {
        ...
        e('[' + n.attr_name() + ']', this.scope).each(function () {
          ...
          !e(this.scope).attr(n.attr_name()) ||
            e(this.scope).attr(n.attr_name(), t),
          n.reflow();
      },
      reflow: function () {
        var t = this;
    ...
    Foundation.libs.joyride = {
      ...
      init: function (t, n, r) {
        Foundation.inherit(this, 'throttle random_str'),
          (this.settings =
            this.settings || e.extend({}, this.defaults, r || n)),
          this.bindings(n, r);
      },
      events: function () {
        var n = this;
      ...
      start: function () {
        ...
        if (
          ...
          (this.settings.cookie_monster && !e.cookie(this.settings.cookie_name))
        )
      ...
      button_text: function (t) {
        return (
          this.settings.next_button
            ? ((t = e.trim(t) || 'Next'),
              (t = e(this.settings.template.button).append(t)[0].outerHTML))
            : (t = ''),
          t
        );
      },
      create: function (t) {
        var n =
            t.$li.attr(this.add_namespace('data-button')) ||
            t.$li.attr(this.add_namespace('data-text')),
          r = t.$li.attr('class'),
          i = e(
            this.tip_template({
              tip_class: r,
      ...
      show: function (t) {
        var n = null;
        this.settings.$li === r ||
        e.inArray(this.settings.$li.index(), this.settings.pause_after) === -1
          ? (this.settings.paused
            ...
            this.settings.$li.length && this.settings.$target.length > 0
              ? (t &&
                ...
                (this.settings.tip_settings = e.extend(
                  {},
                  this.settings,
      ...
      set_next_tip: function () {
        (this.settings.$next_tip = e('.joyride-tip-guide').eq(
          this.settings.$li.index()
        )),
      ...
      scroll_to: function () {
        ...
        (n = e(t).height() / 2),
          ...
          r != 0 &&
            e('html, body')
              .stop()
              .animate({ scrollTop: r }, this.settings.scroll_speed, 'swing');
      },
      paused: function () {
        return (
          e.inArray(
            this.settings.$li.index() + 1,
            this.settings.pause_after
          ) === -1
        );
      },
      restart: function () {
      ...
      pos_default: function (e) {
        ...
        if (!/body/i.test(this.settings.$target.selector)) {
          var s = this.settings.tip_settings.tipAdjustmentY
      ...
      show_modal: function () {
        if (!this.settings.$next_tip.data('closed')) {
          ...
          t.length < 1 && e('body').append(this.settings.template.modal).show(),
            /pop/i.test(this.settings.tip_animation)
              ? t.show()
              : t.fadeIn(this.settings.tip_animation_fade_speed);
        }
      },
      expose: function () {
        var n,
      ...
      center: function () {
        ...
        return (
          this.settings.$next_tip.css({
            top:
              (n.height() - this.settings.$next_tip.outerHeight()) / 2 +
              n.scrollTop(),
            left:
              (n.width() - this.settings.$next_tip.outerWidth()) / 2 +
              n.scrollLeft(),
          }),
          !0
        );
      ...
      events: function (n) {
        ...
        i(this.scope)
          ...
          .on('click.fndtn.dropdown', function (t) {
            ...
            if (
              i(t.target).data(r.data_attr()) ||
              i(t.target).parent().data(r.data_attr())
            )
              return;
            if (
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.clearing = {
            ...
            typeof r == 'undefined' && (r = {}),
              ...
              typeof r.is_scrolling == 'undefined' &&
                (r.is_scrolling = !!(
                  r.is_scrolling ||
                  Math.abs(r.delta_x) <
                    Math.abs(e.touches[0].pageY - r.start_page_y)
                ));
      ...
      assemble: function (t) {
        ...
        Modernizr.touch &&
          (a = e(a).find('.clearing-touch-label').html(f).end()),
          s.after(a).remove();
      },
      open: function (t, r, i) {
        function p() {
        ...
        l.error(function () {
          ...
          this.locked() ||
            (f.trigger('open.fndtn.clearing'),
            l.attr('src', this.load(t)).css('visibility', 'hidden'),
            p.call(this));
      },
      close: function (t, r) {
        t.preventDefault();
        ...
        return (
          r === t.target &&
            ...
            (o = e('div', i).first()),
            (u = e('.visible-img', o)),
            u.trigger('close.fndtn.clearing'),
            ...
            u.hide(),
            u.trigger('closed.fndtn.clearing')),
          !1
        );
      },
      is_open: function (e) {
      ...
      resize: function () {
        ...
        t.length &&
          (this.center_and_label(t, n), t.trigger('resized.fndtn.clearing'));
      },
      ...
      update_paddles: function (e) {
        ...
        e.next().length > 0
          ? this.S('.clearing-main-next', t).removeClass('disabled')
          : this.S('.clearing-main-next', t).addClass('disabled'),
          e.prev().length > 0
            ? this.S('.clearing-main-prev', t).removeClass('disabled')
            : this.S('.clearing-main-prev', t).addClass('disabled');
      },
      ...
      go: function (e, t) {
        ...
        r.length &&
          this.S('img', r)
            .trigger('click', [n, r])
            .trigger('click.fndtn.clearing', [n, r])
      ...
      shift: function (e, t, n) {
        ...
        t.index() !== i && !/skip/.test(s)
          ...
          : /skip/.test(s) &&
            ...
            this.lock(),
            f > 0
              ? ((l[o] = -(f * a)), r.animate(l, 300, this.unlock()))
              : ((l[o] = 0), r.animate(l, 300, this.unlock()))),
          n();
      },
      ...
      s = function (i, s) {
        ...
        (f.slides = function () {
          ...
          (f.update_active_link = function (t) {
            var n = e(
              'a[data-orbit-link="' +
                f.slides().eq(t).attr('data-orbit-slide') +
                '"]'
            );
          ...
          (f.build_markup = function () {
            c.wrap('<div class="' + s.container_class + '"></div>'),
              ...
              s.bullets &&
                ...
                f.slides().each(function (t, n) {
                  var r = e('<li>')
                    .attr('data-orbit-slide', t)
    ...
    Foundation.libs.offcanvas = {
      ...
      events: function () {
        var e = this,
          ...
          r = '',
          i = '';
        this.settings.open_method === 'move'
          ? ((n = 'move-'), (r = 'right'), (i = 'left'))
          : this.settings.open_method === 'overlap' &&
            (n = 'offcanvas-overlap'),
          t(this.scope)
            .off('.offcanvas')
            .on(
    ...
    Foundation.libs['magellan-expedition'] = {
        ...
        n.set_expedition_position(),
          r(n.scope)
            ...
            .on(
              ...
              '[' + n.add_namespace('data-magellan-arrival') + '] a[href^="#"]',
              function (t) {
                t.preventDefault();
            ...
            .on(
              ...
              n.throttle(this.check_for_arrivals.bind(this), i.throttle_delay)
            ),
          e(t).on(
      ...
      update_expedition_positions: function () {
        ...
        e('[' + this.attr_name() + '=fixed]', n.scope).each(function () {
          ...
          if (r >= s) {
            var o = t.prev(
              '[' + n.add_namespace('data-magellan-expedition-clone') + ']'
            );
            o.length === 0 &&
              ((o = t.clone()),
              o.removeAttr(n.attr_name()),
              o.attr(n.add_namespace('data-magellan-expedition-clone'), ''),
              t.before(o)),
              t.css({ position: 'fixed', top: i.fixed_top });
        ...
        e('[' + this.attr_name() + ']', n.scope).each(function () {
          ...
          s.each(function (e, r) {
            if (r.viewport_offset >= r.top_offset) {
              var s = t.find(
                '[' + n.add_namespace('data-magellan-arrival') + ']'
              );
              return (
                s.not(r.arrival).removeClass(i.active_class),
      ...
      offsets: function (t, n) {
        ...
        return t
          ...
          .map(function (n, o) {
            ...
            if (a.length > 0) {
              var f =
                a.offset().top - i.destination_threshold - t.outerHeight();
              return {
                destination: a,
                arrival: e(this),
                top_offset: f,
          ...
          .sort(function (e, t) {
            return e.top_offset < t.top_offset
              ? -1
              : e.top_offset > t.top_offset
              ? 1
              : 0;
          });
      },
      ...
      reflow: function () {
        var t = this;
        e(
          '[' + t.add_namespace('data-magellan-expedition-clone') + ']',
          t.scope
        ).remove();
      },
    };
            ...
            function (r) {
              ...
              if (f.toggleable && s.is(l)) {
                s.parent('dd').toggleClass(f.active_class, !1),
                  ...
                  i.triggerHandler('toggled', [s]);
                return;
              }
              f.multi_expand ||
                (o.removeClass(f.active_class), u.removeClass(f.active_class)),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.topbar = {
      ...
      init: function (t, n, r) {
        ...
        i.register_media('topbar', 'foundation-mq-topbar'),
          ...
          i.S('[' + this.attr_name() + ']', this.scope).each(function () {
            ...
            t.data('index', 0);
            var s = t.parent();
            s.hasClass('fixed') || i.is_sticky(t, s, n)
              ...
              i.add_custom_rule(
                '.f-topbar-fixed { padding-top: ' + t.data('height') + 'px }'
              ),
      ...
      toggle: function (n) {
        ...
        r.breakpoint() &&
          (r.rtl
            ? (o.css({ right: '0%' }), e('>.name', o).css({ right: '100%' }))
            : (o.css({ left: '0%' }), e('>.name', o).css({ left: '100%' })),
              ...
              t.stopImmediatePropagation(),
                n.hasClass('hover')
                  ...
                  : (n.addClass('hover'),
                    ...
                    s[0].nodeName === 'A' &&
                      s.parent().hasClass('has-dropdown') &&
                      t.preventDefault());
            }
          )
          .on(
            ...
            function (e) {
              if (r.breakpoint()) {
                ...
                n.data('index', n.data('index') + 1),
                  u.addClass('moved'),
                  r.rtl
                    ? (s.css({ right: -(100 * n.data('index')) + '%' }),
                      s
                        .find('>.name')
                        .css({ right: 100 * n.data('index') + '%' }))
                    : (s.css({ left: -(100 * n.data('index')) + '%' }),
                      s
                        .find('>.name')
                        .css({ left: 100 * n.data('index') + '%' })),
                  n.css(
                    'height',
                    t.siblings('ul').outerHeight(!0) + n.data('height')
                  );
              }
            }
          ),
          ...
          i(this.scope).on(
            ...
            function (e) {
              ...
              n.data('index', n.data('index') - 1),
                ...
                n.data('index') === 0
                  ? n.css('height', '')
                  : n.css('height', a.outerHeight(!0) + n.data('height')),
                setTimeout(function () {
                  u.removeClass('moved');
                }, 300);
            }
        ...
        e.S('[' + this.attr_name() + ']').each(function () {
          ...
          e.is_sticky(t, i, r) &&
            (i.hasClass('fixed')
              ? (i.removeClass('fixed'),
                (s = i.offset().top),
                e.S(n.body).hasClass('f-topbar-fixed') &&
                  (s -= t.data('height')),
        ...
        i.detach(),
          n.S('.has-dropdown>a', i).each(function () {
            var t = n.S(this),
              ...
              s = t.attr('href'),
              o;
            i.find('.title.back').length ||
              ((o = e(
                '<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li>'
              )),
              r.custom_back_text == 1
                ? e('h5>a', o).html(r.back_text)
                : e('h5>a', o).html('&laquo; ' + t.html()),
              i.prepend(o));
          }),
          i.appendTo(t),
          this.sticky(),
      ...
      assembled: function (t) {
        t.data(
          this.attr_name(!0),
          e.extend({}, t.data(this.attr_name(!0)), { assembled: !0 })
        );
      },
      height: function (t) {
        var n = 0,
    ...
    Foundation.libs.tab = {
      ...
      toggle_active_tab: function (n, i) {
        ...
        n.addClass(c.active_class).triggerHandler('opened'),
          ...
          f
            .siblings()
            .removeClass(c.active_class)
            .end()
            .addClass(c.active_class),
          c.callback(n),
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.abide = {
        ...
        validators: {
          equalTo: function (e, t, r) {
            var i = n.getElementById(
                e.getAttribute(this.add_namespace('data-equalto'))
              ).value,
              s = e.value,
              o = i === s;
            return o;
        ...
        (this.invalid_attr = this.add_namespace('data-invalid')),
          r
            ...
            .on('submit.fndtn.abide validate.fndtn.abide', function (e) {
              ...
              return n.validate(
                n.S(this).find('input, textarea, select').get(),
                e,
                t
              );
            })
      ...
      validate: function (e, t, n) {
        ...
        return (
          (u || n) && s.trigger('valid').trigger('valid.fndtn.abide'),
      ...
      valid_checkbox: function (e, t) {
        ...
        return (
          n
            ? e.removeAttr(this.invalid_attr).parent().removeClass('error')
            : e.attr(this.invalid_attr, '').parent().addClass('error'),
          n
        );
      },
      ...
      valid_equal: function (e, t, r) {
        ...
        return (
          o
            ? (this.S(e).removeAttr(this.invalid_attr), r.removeClass('error'))
            : (this.S(e).attr(this.invalid_attr, ''), r.addClass('error')),
          o
        );
      },
  ...
  (function (e, t, n, r) {
    ...
    Foundation.libs.tooltip = {
      ...
      should_show: function (t, n) {
        ...
        return r.show_on === 'all'
          ? !0
          : this.small() && r.show_on === 'small'
          ? !0
          : this.medium() && r.show_on === 'medium'
          ? !0
          : this.large() && r.show_on === 'large'
          ? !0
          : !1;
      },
      medium: function () {
          ...
          e(this.scope)
            ...
            .on(
              ...
              function (t) {
                if (/mouse/i.test(t.type) && n.ie_touch(t)) return !1;
                if (
                  e(this).data('tooltip-open-event-type') == 'touch' &&
                  t.type == 'mouseleave'
                )
                  return;
                e(this).data('tooltip-open-event-type') == 'mouse' &&
                /MSPointerDown|touchstart/i.test(t.type)
      ...
      getTip: function (t) {
        ...
        return (
          n &&
            (i = this.S('span[data-selector="' + n + '"]' + r.tooltip_class)),
          typeof i == 'object' ? i : !1
        );
      },
      selector: function (e) {
        ...
        return (
          ((t && t.length < 1) || !t) &&
            typeof n != 'string' &&
            ((n = this.random_str(6)), e.attr('data-selector', n)),
          t && t.length > 0 ? t : n
        );
      },
      create: function (n) {
        ...
        typeof i.tip_template == 'string' &&
          t.hasOwnProperty(i.tip_template) &&
          (s = t[i.tip_template]);
        var o = e(
            s(this.selector(n), e('<div></div>').html(n.attr('title')).html())
          ),
          u = this.inheritable_classes(n);
        o.addClass(u).appendTo(i.append_to),
          Modernizr.touch &&
            (o.append(
              '<span class="tap-to-close">' + i.touch_close_text + '</span>'
            ),
            o.on(
      ...
      reposition: function (t, n, r) {
        ...
        if (this.small())
          ...
          Foundation.rtl &&
            (s.addClass('rtl'),
            (l = t.offset().left + t.outerWidth() - n.outerWidth())),
            f(n, t.offset().top + t.outerHeight() + 10, 'auto', 'auto', l),
            n.removeClass('tip-override'),
            r && r.indexOf('tip-top') > -1
              ? (Foundation.rtl && s.addClass('rtl'),
                f(
                  n,
                  t.offset().top - n.outerHeight(),
                  'auto',
                  'auto',
                  l
              ...
              ? (f(
                  n,
                  t.offset().top + t.outerHeight() / 2 - n.outerHeight() / 2,
                  'auto',
                  'auto',
                  t.offset().left - n.outerWidth() - o
                ).removeClass('tip-override'),
                s.removeClass('rtl'))
              : r &&
